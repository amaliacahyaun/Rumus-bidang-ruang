...
public class Tugas1 {
   ...
   for(String b = "y"; b.equals("y") || b.equals("Y");){
        ...
        double Volume = rumusbalok.volume(panjang,lebar,tinggi);
        ...
        double Volume = rumuslimas.volume(asegitiga,tsegitiga,tlimas);
        System.out.println("Volume Limas Segitiga="+ Volume);
        double Luasper = rumuslimas.luasper(asegitiga, tsegitiga,sisibc,tsisi2,sisiac,tsisi3,tsisi4);
        System.out.println("Luas Permukaan Kerucut="+ Luasper);
